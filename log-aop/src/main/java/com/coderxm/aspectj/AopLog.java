...
public class AopLog {
     ...
     * 切入点
     */
    @Pointcut("execution(public * com.coderxm.controller.*Controller.*(..))")
    // @Pointcut("@annotation(com.coderxm.annotation.AopLogAnnotation)")// 用注解的方式记录日志
    public void log() {
